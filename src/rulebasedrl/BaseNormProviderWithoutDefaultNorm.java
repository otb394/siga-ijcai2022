...
public class BaseNormProviderWithoutDefaultNorm implements NormProvider {
    ...
    public List<NormEntry> provide() {
        ...
        initialNorms.add(new NormEntry(new Norm(Context.builder().calleeLocation(Location.HOME).build(),
                Action.RING)));
        initialNorms.add(new NormEntry(new Norm(Context.builder().calleeLocation(Location.ER).build(),
                Action.RING)));
        initialNorms.add(new NormEntry(new Norm(Context.builder().calleeLocation(Location.PARTY).build(),
                Action.RING)));
        ...
        initialNorms.add(new NormEntry(new Norm(
                ...
                Action.RING)));
//        initialNorms.add(new NormEntry(new Norm(
//                Context.builder().build(), base.Action.RING)));
        return initialNorms;
    }
}
